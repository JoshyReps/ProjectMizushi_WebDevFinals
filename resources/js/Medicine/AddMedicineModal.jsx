// resources/js/pages/inventory/medication/AddMedicineModal.jsx
import { useForm } from '@inertiajs/react';

const AddMedicineModal = ({ isOpen, onClose }) => {
    // Inertia useForm setup for 'add'
    const { data, setData, post, processing, reset, errors } = useForm({
        med_name: '',
        gen_name: '',
        category: '', // Changed default to empty string for text input
        selling_unit: 'Piece',
        selling_price: '',
        min_stock_level: 10,
        net_content: '',
            ...
            >
                <div className="flex h-full flex-col">
                    <div className="flex items-center justify-between border-b border-gray-200 bg-white px-6 py-4">
                        <h2 className="text-xl font-bold text-gray-800">Create New Medicine</h2>
                    ...
                    <div className="flex-1 overflow-y-auto px-6 py-4">
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="mt-8 flex flex-col gap-3">
                                ...
                                >
                                    {processing ? 'Processing...' : 'Add Medicine'}
                                </button>
                            </div>
                        </form>
                    </div>
